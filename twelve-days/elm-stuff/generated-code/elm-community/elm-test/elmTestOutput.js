...
var _user$project$TwelveDays$givenItemByDay = function (number) {
	var _p0 = number;
	switch (_p0) {
		case 1:
...
var _user$project$TwelveDays$givenItemsList = F2(
	function (number, acc) {
		var _p1 = number;
		if (_p1 === 1) {
			return A2(
				_elm_lang$core$String$append,
				A2(_elm_lang$core$Basics_ops['++'], acc, ', and a '),
				_user$project$TwelveDays$givenItemByDay(1));
		} else {
			var _p2 = _p1;
			return A2(
				_elm_lang$core$String$append,
				...
				A2(
					_user$project$TwelveDays$givenItemsList,
					_p2 - 1,
					_user$project$TwelveDays$givenItemByDay(_p2)));
		}
	});
var _user$project$TwelveDays$stringifyNumber = function (number) {
	var _p3 = number;
	switch (_p3) {
		case 1:
			return 'first';
...
var _user$project$TwelveDays$prefix = function (number) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'On the ',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$TwelveDays$stringifyNumber(number),
			' '));
};
var _user$project$TwelveDays$commonWords = 'day of Christmas my true love gave to me';
var _user$project$TwelveDays$buildPoem = F2(
	function (start, stop) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$TwelveDays$prefix(start),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$TwelveDays$commonWords,
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_user$project$TwelveDays$givenItemsList, start, ''),
					'.')));
	});
...
var _user$project$Tests$tests = A2(
			...
			A2(
				...
				function (_p0) {
					...
					return A2(
						...
						{
							ctor: '::',
							_0: 'On the first day of Christmas my true love gave to me, a Partridge in a Pear Tree.',
							_1: {ctor: '[]'}
						},
						A2(_user$project$TwelveDays$recite, 1, 1));
				})),
		_1: {
			ctor: '::',
			_0: A2(
				...
				function (_p2) {
					...
					return A2(
						...
						{
							ctor: '::',
							_0: 'On the second day of Christmas my true love gave to me, two Turtle Doves, and a Partridge in a Pear Tree.',
							_1: {ctor: '[]'}
						},
						A2(_user$project$TwelveDays$recite, 2, 2));
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					function (_p4) {
						...
						return A2(
							...
							{
								ctor: '::',
								_0: 'On the third day of Christmas my true love gave to me, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
								_1: {ctor: '[]'}
							},
							A2(_user$project$TwelveDays$recite, 3, 3));
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						function (_p6) {
							...
							return A2(
								...
								{
									ctor: '::',
									_0: 'On the fourth day of Christmas my true love gave to me, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
									_1: {ctor: '[]'}
								},
								A2(_user$project$TwelveDays$recite, 4, 4));
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							function (_p8) {
								...
								return A2(
									...
									{
										ctor: '::',
										_0: 'On the fifth day of Christmas my true love gave to me, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
										_1: {ctor: '[]'}
									},
									A2(_user$project$TwelveDays$recite, 5, 5));
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								function (_p10) {
									...
									return A2(
										...
										{
											ctor: '::',
											_0: 'On the sixth day of Christmas my true love gave to me, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
											_1: {ctor: '[]'}
										},
										A2(_user$project$TwelveDays$recite, 6, 6));
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									function (_p12) {
										...
										return A2(
											...
											{
												ctor: '::',
												_0: 'On the seventh day of Christmas my true love gave to me, seven Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
												_1: {ctor: '[]'}
											},
											A2(_user$project$TwelveDays$recite, 7, 7));
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										function (_p14) {
											...
											return A2(
												...
												{
													ctor: '::',
													_0: 'On the eighth day of Christmas my true love gave to me, eight Maids-a-Milking, seven Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
													_1: {ctor: '[]'}
												},
												A2(_user$project$TwelveDays$recite, 8, 8));
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											function (_p16) {
												...
												return A2(
													...
													{
														ctor: '::',
														_0: 'On the ninth day of Christmas my true love gave to me, nine Ladies Dancing, eight Maids-a-Milking, seven Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
														_1: {ctor: '[]'}
													},
													A2(_user$project$TwelveDays$recite, 9, 9));
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												function (_p18) {
													...
													return A2(
														...
														{
															ctor: '::',
															_0: 'On the tenth day of Christmas my true love gave to me, ten Lords-a-Leaping, nine Ladies Dancing, eight Maids-a-Milking, seven Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
															_1: {ctor: '[]'}
														},
														A2(_user$project$TwelveDays$recite, 10, 10));
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													function (_p20) {
														...
														return A2(
															...
															{
																ctor: '::',
																_0: 'On the eleventh day of Christmas my true love gave to me, eleven Pipers Piping, ten Lords-a-Leaping, nine Ladies Dancing, eight Maids-a-Milking, seven Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
																_1: {ctor: '[]'}
															},
															A2(_user$project$TwelveDays$recite, 11, 11));
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														function (_p22) {
															...
															return A2(
																...
																{
																	ctor: '::',
																	_0: 'On the twelfth day of Christmas my true love gave to me, twelve Drummers Drumming, eleven Pipers Piping, ten Lords-a-Leaping, nine Ladies Dancing, eight Maids-a-Milking, seven Swans-a-Swimming, six Geese-a-Laying, five Gold Rings, four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.',
																	_1: {ctor: '[]'}
																},
																A2(_user$project$TwelveDays$recite, 12, 12));
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															function (_p24) {
																...
																return A2(
																	...
																	A2(_user$project$TwelveDays$recite, 1, 3));
															}),
														_1: {
															ctor: '::',
															_0: _elm_community$elm_test$Test$skip(
																A2(
																	...
																	function (_p26) {
																		...
																		return A2(
																			...
																			A2(_user$project$TwelveDays$recite, 4, 6));
																	})),
															_1: {
																ctor: '::',
																_0: _elm_community$elm_test$Test$skip(
																	A2(
																		...
																		function (_p28) {
																			...
																			return A2(
																				...
																				A2(_user$project$TwelveDays$recite, 1, 12));
																		})),
																_1: {ctor: '[]'}
															}
														}
...
var _user$project$Test_Generated_Main1983487270$main = A2(
...
if (typeof _user$project$Test_Generated_Main1983487270$main !== 'undefined') {
    _user$project$Test_Generated_Main1983487270$main(Elm['Test']['Generated']['Main1983487270'], 'Test.Generated.Main1983487270', undefined);
}
...
var report = "console";
var pipeFilename = "/tmp/elm_test-8006.sock";
